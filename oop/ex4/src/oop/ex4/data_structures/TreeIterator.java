...
public class TreeIterator implements Iterator<Integer>{
    ...
    private Node nextNodeToTakeOut;

    /* constructor */
    public TreeIterator(Node rootNode) {
        // start by setting nextNodeToTakeOut to be the minimum node in the tree
     ...
     *
     * @return the data in the next node in ascending order
     */
    @Override
    public Integer next() {
